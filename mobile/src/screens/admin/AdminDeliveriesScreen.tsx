...
const s = StyleSheet.create({
  ...
  name: { fontSize: 17.5, fontWeight: '800', color: T.text },
  badge: { paddingHorizontal: 9, paddingVertical: 3, borderRadius: 9 },
  badgeText: { fontSize: 12.5, fontWeight: '800' },
  sub: { fontSize: 14, color: T.textSub, marginTop: 2, lineHeight: 20 },
  items: { fontSize: 13, color: T.textSub, marginTop: 1 },
  ...
  detailValue: { fontSize: 16, color: T.text, fontWeight: '600', lineHeight: 22 },
