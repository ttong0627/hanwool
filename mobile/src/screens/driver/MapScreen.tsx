...
const s = StyleSheet.create({
  ...
  stopItem: { fontSize: 14, color: T.text, marginTop: 1, fontWeight: '700' },
  stopAddr: { fontSize: 13.5, color: T.textSub, marginTop: 1 },
  stopReq: { fontSize: 12.5, color: T.primary, marginTop: 2, fontWeight: '600' },
  ...
  detailLabel: { fontSize: 13, color: T.textMuted, fontWeight: '700', marginBottom: 2 },
  detailValue: { fontSize: 16.5, color: T.text, fontWeight: '600', lineHeight: 23 },
  detailActions: { flexDirection: 'row', gap: 10, marginTop: 16 },
  actionBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 16, borderRadius: 14, minHeight: 52 },
  actionText: { color: '#fff', fontSize: 16.5, fontWeight: '800' },
})
