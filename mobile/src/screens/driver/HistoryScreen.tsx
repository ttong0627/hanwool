...
const styles = StyleSheet.create({
  ...
  dRow:     { flexDirection: 'row', paddingVertical: 7, borderBottomWidth: 1, borderBottomColor: '#F1F5F9' },
  dLabel:   { width: 76, fontSize: 13, color: T.textMuted, fontWeight: '700' },
  dValue:   { flex: 1, fontSize: 14, color: T.text, fontWeight: '600' },
