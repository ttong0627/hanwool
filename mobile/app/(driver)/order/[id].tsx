...
const st = StyleSheet.create({
  ...
  custName: { fontSize: 20, fontWeight: '800', color: T.dark, marginBottom: 8 },
  addrRow: { flexDirection: 'row', gap: 6, marginBottom: 10 },
  addr: { flex: 1, fontSize: 16.5, color: T.sub, lineHeight: 23 },
  row: { flexDirection: 'row', paddingVertical: 8, borderTopWidth: 1, borderTopColor: '#F1F5F9' },
  rowLabel: { width: 96, fontSize: 14, fontWeight: '700', color: T.muted },
  rowValue: { flex: 1, fontSize: 15.5, color: T.dark },
  actionRow: { flexDirection: 'row', gap: 10, marginBottom: 12 },
  actionBtn: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6,
    paddingVertical: 15, borderRadius: 12, borderWidth: 1.5, backgroundColor: T.card, minHeight: 52,
  },
  actionText: { fontSize: 16.5, fontWeight: '800' },
